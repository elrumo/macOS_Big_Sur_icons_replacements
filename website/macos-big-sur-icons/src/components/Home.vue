  ...
  <div>
    ...
    <section class="content-wrapper">
      ...
      <div class="main-search-wrapper">
        ...
        <div class="coral-Form coral-Form--vertical m-auto main-search" style="max-width:300px;">
          <div class="shadow main-border-radius">
            <input v-model="search" type="text" is="coral-textfield" class="_coral-Search-input _coral-Textfield" name="name" aria-label="text input">
