    ...
    <coral-dialog-content>
      ...
      <div class="dialog-text">
        ...
        <ul class="coral-List p-t-10 p-b-10">
          ...
          <li class="coral-List-item">Use <a alt="Download Sketch template" href="https://github.com/elrumo/macOS_Big_Sur_icons_replacements/raw/master/design/Template-Icon-App.sketch" class="coral-Link"> this </a> template for dimensions and reference.</li>
